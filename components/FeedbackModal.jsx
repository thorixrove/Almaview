                            ...
                            <div className="flex flex-col gap-2">
                                {feedback.strengths?.map((s, i) => (
                                    <Badge
                                        key={i}
                                        variant="outline"
                                        className="justify-start items-start text-left border-green-500/20 text-green-400 whitespace-normal h-auto py-1.5"
                                    >
                                        ✓ {s}
                                    </Badge>
                                ))}
                            ...
                            <div className="flex flex-col gap-2">
                                {feedback.improvements?.map((imp, i) => (
                                    <Badge
                                        key={i}
                                        variant="outline"
                                        className="justify-start items-start text-left border-red-500/20 text-red-400 whitespace-normal h-auto py-1.5"
                                    >
                                        ✓ {imp}
                                    </Badge>
                                ))}
