...
function Button({
  ...
  // Base UI doesn't use Radix's `asChild` pattern — it uses a `render`
  // prop instead. This keeps `asChild` working as a drop-in so existing
  // call sites like `<Button asChild><Link .../></Button>` don't need
